...
void main()
{
  ...
  // tcColor[ID] = vColor[ID];
    vec3 n0 = cross( vCartesianPosition[2] - vCartesianPosition[0]
                   , vCartesianPosition[1] - vCartesianPosition[0]);
    tcColor[ID] = normalize(n0 * sign(- dot(vCartesianPosition[0], n0)));
